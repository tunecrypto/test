...
{
    const char* pszTimestamp = "Here's to the ones who dream";
    const CScript genesisOutputScript = CScript() << ParseHex("04bcc101fa13fdfcf4ac799520dfd0c80848cd6ad332bb0c6ac1d8dc04bd13fa1c1a09c8742e53f71f03a9ea800f0a5ceb6d2b791b7ce045dd62418f2259a501d8") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 15 * 60; // Tune: 15 min, 10 blocks
        consensus.nPowTargetSpacing = 1.5 * 60; // Tune: 90 seconds
        ...
        genesis = CreateGenesisBlock(1514683999, 525149, 0x1e0ffff0, 1, 300000 * COIN);

        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000594ae5798a75fdb001919f001897215903edee7057e26abb0f0e55a386c"));
        assert(genesis.hashMerkleRoot == uint256S("0xcc841b3a77d07c8e965c2d4812319da5eea95b57f467bb661ac4113cb840f0fb"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // vSeeds.push_back(CDNSSeedData("94.176.239.233:10725", "94.176.239.233:10725"));

        // Tune addresses start with 'T'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,65);
        // Tune script addresses start with '5'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,10);
        // Tune private keys start with '5' or 'T' (?)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,65);

        // Tune BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Tune BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // Tune BIP44 coin type is '5'
        ...
        checkpointData = (CCheckpointData) {
            ...
            (    0, uint256S("0x0000093401c69b1f26f083478c6fcf21411a8a0d86ba0eb685bab4952bb1f9ce")),


            1514683999, // * UNIX timestamp of last checkpoint block
...
public:
    CTestNetParams() {
        ...
        // Testnet Tune script addresses start with '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,20);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults) (?)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,240);
        // Testnet Tune BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Tune BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Testnet Tune BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams() {
        ...
        // Regtest Tune addresses start with 'n'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,112);
        // Regtest Tune script addresses start with '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,20);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults) (?)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,240);
        // Regtest Tune BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest Tune BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Regtest Tune BIP44 coin type is '1' (All coin's testnet default)
        base58Prefixes[EXT_COIN_TYPE]  = boost::assign::list_of(0x80)(0x00)(0x00)(0x01).convert_to_container<std::vector<unsigned char> >();
   }
};
