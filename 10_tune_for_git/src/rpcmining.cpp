...
//    if (vNodes.empty())
//        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "Tune Core is not connected!");

//    if (IsInitialBlockDownload())
//        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "Tune Core is downloading blocks...");

//    if (!masternodeSync.IsSynced())
//        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "Tune Core is syncing with network...");
