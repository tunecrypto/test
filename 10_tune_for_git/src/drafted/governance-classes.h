 ...
 *
 *   // network
 *   CTuneNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.tune.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CTuneNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: TuneNetwork
// //   -- signature requirements : Key1(User)
// class CTuneNetworkVariable : public CGovernanceObject
// {
// private:
