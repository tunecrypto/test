...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "TuneNetwork") type = TuneNetwork;
    if(strType == "TuneNetworkVariable") type = TuneNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == TuneNetwork) s = "TuneNetwork";
    if(type == TuneNetworkVariable) s = "TuneNetworkVariable";
