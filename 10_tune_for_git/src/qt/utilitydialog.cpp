    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Tune Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Tune Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  tune-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Tune in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 TUN, 0.1 TUN, 1 TUN and 10 TUN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://tunecoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://tunecoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Tune Core is shutting down...") + "<br /><br />" +
