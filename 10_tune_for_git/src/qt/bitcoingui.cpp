    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Tune Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Tune address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and tune: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Tune Core"), this);
    aboutAction->setStatusTip(tr("Show information about Tune Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Tune Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Tune addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Tune addresses"));
    ...
    openAction->setStatusTip(tr("Open a tune: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Tune Core help message to get a list with possible Tune Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Tune Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Tune network", "", count));
}
...
{
    QString strTitle = tr("Tune Core"); // default title
