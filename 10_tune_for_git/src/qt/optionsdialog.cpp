    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("TUN-light"), QVariant("light"));
    ui->theme->addItem(QString("TUN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("TUN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("TUN-traditional"), QVariant("trad"));
